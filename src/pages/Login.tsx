...
export function Login({ onLogin, onRegister, isDarkMode, toggleTheme }: LoginProps) {
  return (
    <motion.div 
          ...
          <form className="space-y-6" onSubmit={onLogin}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label className="text-[11px] font-bold tracking-widest text-on-surface-variant uppercase">
                  CONTRASEÑA
                </label>
                <button type="button" className="text-[11px] font-medium text-primary hover:text-primary-dim transition-colors">
